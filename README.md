...
[find-largests-files.sh](https://github.com/anargis/one-line-command/blob/main/find-largest-files.sh) - Lists the 20 largest files within a given directory (e.g., /home)
